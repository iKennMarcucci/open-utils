      ...
      <div className="w-full max-w-4xl space-y-12">
        ...
        >
          <h1 className="text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-neutral-200 to-neutral-500">
            {mode === "pdf-to-img" ? "PDF to IMG" : "IMG to PDF"}
          </h1>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div
              ...
              className={cn(
                "group relative flex-1 flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-8 transition-all overflow-hidden min-h-[350px] bg-neutral-900/50",
                file
                  ? "border-neutral-800 cursor-default"
                  : "border-neutral-800 hover:border-neutral-600 hover:bg-neutral-900 cursor-pointer",
              ...
              <AnimatePresence mode="wait">
                {!file ? (
                  ...
                  >
                    ...
                    <div className="text-xs text-neutral-600 mt-4 flex items-center gap-2">
                      {mode === "pdf-to-img" ? (
                        <>
                  ...
                  >
                    {/* File Preview */}
                    <div className="flex-1 overflow-hidden relative bg-neutral-950 flex items-center justify-center">
                      {filePreview ? (
                        <img
                          src={filePreview}
                          alt="File Preview"
                        ...
                        <FileText className="w-32 h-32 text-neutral-800" />
                      )}
                      ...
                      <div className="absolute inset-4 flex flex-col justify-end pointer-events-none">
                         <div className="flex justify-between items-end backdrop-blur-md bg-black/40 p-4 rounded-xl border border-white/5 pointer-events-auto">
                            ...
                            <button
                              ...
                              className="p-2 bg-white/10 hover:bg-red-500/20 text-neutral-300 hover:text-red-400 rounded-lg transition-colors shrink-0"
                            >
                              <X className="w-4 h-4" />
                            </button>
                         </div>
          ...
          >
            <div className="flex justify-between items-end mb-3 ml-1">
              ...
              {results && results.length > 1 && (
                <button 
                  ...
                  className="text-xs text-white bg-white/10 hover:bg-white/20 px-3 py-1 rounded-full transition-colors flex items-center gap-1.5"
                >
            ...
            <div
              className={cn(
                "relative flex-1 flex flex-col items-center justify-center border border-neutral-800 rounded-2xl transition-all overflow-hidden min-h-[350px]",
                results ? "bg-neutral-900 border-neutral-700" : "bg-neutral-950/50"
              )}
            >
              <AnimatePresence mode="wait">
                {isConverting ? (
        ...
        {fullscreenResult && (
          ...
          >
            ...
            <div className="h-16 border-b border-white/10 flex items-center justify-between px-6 bg-black/50">
              <span className="text-sm font-medium text-neutral-400 truncate max-w-[300px]">
              ...
              <div className="flex items-center gap-4">
                 ...
                 <button
                   ...
                   className="p-2 bg-white/5 hover:bg-white/10 text-neutral-400 hover:text-white rounded-full transition-colors"
                 >
                   <X className="w-5 h-5" />
                 </button>
              </div>
            ...
            <div className="flex-1 overflow-auto p-4 sm:p-8 flex items-center justify-center">
               {fullscreenResult.type === "application/pdf" ? (
                 ...
                 <div className="relative aspect-[3/4] bg-neutral-800 rounded-2xl overflow-hidden group shadow-lg">
                   <img
                     src={fullscreenResult.url}
                     alt="Preview"
